...
export default async function DashboardMarketingPage() {
  ...
  return (
    <div data-marketing-scroll className="h-full overflow-y-auto font-sys bg-sys-bg text-sys-primary" style={{ scrollBehavior: 'smooth' }}>
      <JsonLd data={productJsonLd('dashboard')} />
...
function Hero({ cta }: { cta: { href: string; label: string } }) {
  return (
    <>
    <section className="flex flex-col justify-center" style={{ background: 'radial-gradient(120% 90% at 92% -8%, rgba(250,195,205,0.7) 0%, rgba(255,255,255,0) 56%), linear-gradient(180deg, #fdeef1 0%, #fdf6f7 42%, #ffffff 92%)', paddingTop: 56, paddingBottom: 48 }}>
