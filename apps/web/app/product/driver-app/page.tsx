...
import { AppStoreBadge, APP_STORE_URL, PLAY_STORE_URL } from '@/components/marketing/AppStoreBadge';
...
export default async function DriverMarketingPage() {
  ...
  return (
    <div data-marketing-scroll className="h-full overflow-y-auto font-sys bg-sys-bg text-sys-primary" style={{ scrollBehavior: 'smooth' }}>
      <JsonLd data={productJsonLd('driver-app')} />
        ...
        <Reveal delay={140}>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 22 }}>
            ...
            <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', justifyContent: 'center' }}>
              <AppStoreBadge kind="apple" href={APP_STORE_URL} />
              <AppStoreBadge kind="google" href={PLAY_STORE_URL} />
            </div>
          </div>
        </Reveal>
      </div>
...
// AppStoreBadge now lives in @/components/marketing/AppStoreBadge (shared
// with the site footer, with the live store URLs baked in).
