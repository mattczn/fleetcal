...
// SVG donut chart lifted to components/ui/PieChart.tsx so the
// /expenses workspace renders the same chart. Imported above.
...
// Cost-breakdown bar lifted to components/ui/CostBar.tsx so the
